...
# Armazenamento com números de dias desde 1 de janeiro de 1970

# Time - representado por POSIXct
# Armazenamento como número de segundos desde 1 de janeiro de 1970
...
# %a: dia da semana abreviado (Friday)
# %b: mês (July)
# %b: mês abreviado (Jul)
...
# --------------------- TRABALHANDO COM DATAS PARTE 2 --------------------- #

# Convetendo Data em formatos espécificos
...
difftime(b2, b1, units = "weeks") # Retornando semanas
...
tm1.dechr <- hour(tm1.lub) + minute(tm1.lub) / 60 + second(tm1.lub)
tm1.dechr
force_tz(tm1.lub, "Pacific/Auckland")

# Gerando um data frame de datas
